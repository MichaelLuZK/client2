...
import com.casic.common.job.BaseJob;
import com.casic.common.service.WebSocketService;
import com.casic.common.utils.RedisUtil;
...
public class HelloController {
    ...
    @GetMapping("/hello1")
    @ApiOperation(value="测试方法1无参数+get", notes="测试方法1无参数+get")
    ...
    @PostMapping("/hello2")
    @ApiOperation(value="测试方法2有参数+post", notes="测试方法2有参数+post")
    public String hello2(@RequestParam(value="jobClassName")String jobClassName){
        System.out.println("-------------");
        return "hello world!!";
    }
